  ...
  return (
    <form onSubmit={submitHandler} className="flex flex-col w-full items-start gap-3">
      ...
      <div className="w-full">
        ...
        value={description} className="w-full max-w-[500px] px-3 py-2 border" type='text' placeholder="Write description"></textarea>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        <div>
         ...
         value={category} className="w-full px-3 py-2 border">
        ...
        <select className="w-full px-3 py-2 border" onChange={(e)=>setSubCategory(e.target.value)}
        value={subCategory}>
       ...
       <div>
        ...
        value={price} className="w-full px-3 py-2 sm:w-[120px] border" type="Number" placeholder="25"/>
       </div>
